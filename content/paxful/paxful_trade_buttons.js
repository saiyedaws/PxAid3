...
function createButton_typeCode(index) {
	...
	var buttonInnerText = "#"+index+" - Type the Code Please - (Multi MSG - Click Repeatedly)";
...
function createButton_whyCancel(index) {
	var messageArray = ["Brother why did you cancel? Please open the trade again and send me a valid gift card code. I want to work with you my brother and build a long lasting relationship with you my friend"];
...
function createButton_multipleGiftCards(index) {
	var messageArray = ["Hey Brother, if you have multiple gift cards, please cancel the trade and open offers for each card, one by one, my brother!"];
