...
function createLeaveFeedbackButton() 
{
    ...
    var leaveFeedbackButton = document.getElementsByClassName("title-container")[0];
    ...
    autoLeaveFeedbackButton.onclick = function () {
        ...
        var feedbackMsg = "It was a real pleasure trading with you brother. Just like this trade, every time you open a trade with me, the transaction will go smooth and fast. Thanks for your responsiveness and honesty.";
        var successfulTradeMsg = 'Thank You it worked Brother. Please leave me a good feedback and add me as Trusted. I will do same!  Brother please trade me if you have anymore giftcards, thank you friend.\r\n\r\nIt was a real pleasure trading with you brother. Just like this trade, every time you open a trade with me, the transaction will go smooth and fast. Thanks for your responsiveness and honesty.\r\n\r\n';

        var chatBoxTextArea = document.querySelector(
			".px-2.form-control.border-transparent.p-0.pt-1.pt-sm-0.regular-24"
        );
        
      var feedbackMessageBoxArea = document.querySelectorAll('[id="feedback-message"]')[0];

    
      writeInChat(successfulTradeMsg, chatBoxTextArea);
      setTimeout(() => {
        var submitMessageButton = document.querySelectorAll('.d-flex.align-items-center.btn.btn-primary.btn-md')[0];
...
function submitFeedback(text, textAreaElement) 
{
    ...
    setTimeout(() => {
        ...
        input.dispatchEvent(new Event('input', { bubbles: true }));
        focusOnTextBoxAtEndOfTheLine(textAreaElement);
        var submitFeedbackButton = document.querySelectorAll('[id="feedback-submit"]')[0];
